...
public class Player : MonoBehaviour
{
    ...
    public bool ChangeLocation(GameController controller , string connectinNoun)
    {
        Connection connection = currentLocation.GetConnection(connectinNoun);
        if (connection != null)
        {
    ...
    internal bool CanUseItem(GameController contoller, Item item)
    {
        if (item.targetItem == null)
            return true;
